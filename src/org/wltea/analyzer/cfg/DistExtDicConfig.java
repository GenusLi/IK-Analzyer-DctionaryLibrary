 ...
 *
 */
public class DistExtDicConfig implements Configuration {

	//配置文件路径
	private static final String FILE_NAME="CustomExtDist.cfg.xml";
	//配置文件上下文
	...
	public static Configuration getInstance() {
		return new DistExtDicConfig();
	}
	
	private DistExtDicConfig() {
