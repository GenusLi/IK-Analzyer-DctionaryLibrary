 ...
 * 市级地域配置实现
 */
public class CityExtDicConfig implements Configuration {

	//配置文件路径
	private static final String FILE_NAME="CustomExtCity.cfg.xml";
	//配置文件上下文
	...
	public static Configuration getInstance() {
		return new CityExtDicConfig();
	}
	
	private CityExtDicConfig() {
