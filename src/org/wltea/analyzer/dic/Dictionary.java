 ...
 * 由原单一词典本修改为词典库
 * 词典库配置方式
 * 实现org.wltea.analyzer.cfg.Configuration接口
 * 添加*.cfg.xml配置文件指定词典本位置、停止词词典本位置、量词词典本位置，配置粒度拆分
 * */
...
//	private static Dictionary singleton;
	...
	private Dictionary(Configuration cfg) {
		this.cfg = cfg;
		this.loadMainDict(); // 加载主词典
		this.loadStopWordDict(); // 记载停止词典
		this.loadQuantifierDict(); // 加载量词词典
	}
